...
{
    class Unban : Utils.IExecutor
    {
        private InputTelegram _inputTelegram;
        private ITelegramBotClient _botClient;
        private Telegram.Bot.Types.Message _message;
        public Unban(InputTelegram inputTelegram,
        ...
        private async Task its_admin()
        {
            try
            {
                ...
                string text = TranslateLocale.CreateTranslation(
                    this._message, new fadhil_robot.TranslationString.Groups.Unban.Success(),
                    userids.ToString()
                );
                await this._botClient.SendTextMessageAsync(
                    chatId: this._inputTelegram.chat_id,
            ...
            {
                string text = TranslateLocale.CreateTranslation(
                    this._message, new fadhil_robot.TranslationString.Groups.Unban.DoubleInputException()
                );
                await this._botClient.SendTextMessageAsync(
                    chatId: this._inputTelegram.chat_id,
                    text: text,
            ...
            {
                string text = TranslateLocale.CreateTranslation(
                    this._message, new fadhil_robot.TranslationString.Groups.Unban.ArgumentNullException()
                );
                await this._botClient.SendTextMessageAsync(
                    chatId: this._inputTelegram.chat_id,
                    text: text,
